            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-slate-800 text-left">
                  ...
                  <th className="px-4 py-3 text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide">Notes</th>
                </tr>
              </thead>
                ...
                {allInventory.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                      ...
                      <td className="px-4 py-3 text-gray-500 dark:text-slate-400 max-w-[160px] truncate">{item.notes ?? "—"}</td>
                    </tr>
                  );
                })}
              </tbody>
